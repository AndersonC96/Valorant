...
<html>
    ...
    <body>
        <?php
            $url = 'https://valorant-api.com/v1/version?language=pt-BR';
            $ch = curl_init($url);
            ...
            <div class="row">
                <?php
                    foreach($resultado->data as $agente){
                        $id = str_replace("https://valorant-api.com/v1/version/", "", $agente->uuid);
                ?>
                <div class="col-3">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="https://seeklogo.com/images/V/valorant-logo-FAB2CA0E55-seeklogo.com.png" alt="Imagem do agente <?php echo $agente->displayName; ?>">
                        <div class="card-body">
                            <p class="card-text">
                                <b style="color: #ff4655">Branch: </b><?php echo $agente->branch; ?><br>
                                <b style="color: #ff4655">Versão: </b><?php echo $agente->version; ?> <br>
                                <b style="color: #ff4655">Versão da build: </b> <?php echo $agente->buildVersion; ?><br>
                                <b style="color: #ff4655">Versão da engine: </b> <?php echo $agente->engineVersion; ?><br>
                                <b style="color: #ff4655">Versão launcher RIOT: </b> <?php echo $agente->riotClientVersion; ?><br>
                                <b style="color: #ff4655">Build launcher da RIOT: </b> <?php echo $agente->riotClientBuild; ?><br>
                                <b style="color: #ff4655">Data da build: </b> <?php echo date("d/m/Y",strtotime($agente->buildDate)) ?><br>
                                <b style="color: #ff4655">Habilidades:</b>
                                <ul>
                                    <?php
                                        foreach($agente->data as $version){
                                            echo "<li>".$habilidade->displayName."</li>";
                                            echo "<b style='color: #ff4655'>".$version->displayName."</b>";
                                        }
                                    ?>
                                </ul>
                                <br>
