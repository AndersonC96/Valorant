            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $nivel->displayIcon; ?>" alt="Imagem do nível <?php echo $nivel->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $nivel->displayName; ?></h5>
                        </div>
                    </div>
                </div>
                <?php
