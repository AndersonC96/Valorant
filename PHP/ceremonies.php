<?php
    ...
    $cerimonias = $resultado->data;
    $totalCerimonias = count($cerimonias);
    $cerimoniasPerPage = 12;
    $totalPages = ceil($totalCerimonias / $cerimoniasPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $cerimoniasPerPage;
    $currentCerimonias = array_slice($cerimonias, $start, $cerimoniasPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
        ...
        <title>Valorant | Cerimônias</title>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-4">Cerimônias</h2>
            <div class="row">
                <?php
                    foreach($currentCerimonias as $cerimonia){
                        $id = str_replace("https://valorant-api.com/v1/ceremonies/", "", $cerimonia->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $cerimonia->displayName; ?></h5>
                        </div>
                    </div>
                </div>
                <?php
