...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>Títulos dos Jogadores</h2>
            <div class="row">
                <?php
                    foreach($resultado->data as $agente){
                        $id = str_replace("https://valorant-api.com/v1/playertitles/", "", $agente->uuid);
                ?>
                <div class="col-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $agente->displayName; ?> (<?php echo $agente->titleText; ?>)</h5>
                        </div>
                    </div>
                </div>
                <?php
