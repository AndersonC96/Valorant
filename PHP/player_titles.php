<?php
    ...
    $url = 'https://valorant-api.com/v1/playertitles?language=pt-BR';
    $ch = curl_init($url);
    ...
    $titulosPerPage = 12;
    $totalPages = ceil($totalTitulos / $titulosPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $titulosPerPage;
    $currentTitulos = array_slice($titulos, $start, $titulosPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
        ...
        <title>Valorant | Títulos dos Jogadores</title>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-4">Títulos dos Jogadores</h2>
            <div class="row">
                <?php
                    foreach($currentTitulos as $titulo){
                        $id = str_replace("https://valorant-api.com/v1/playertitles/", "", $titulo->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="https://seeklogo.com/images/V/valorant-logo-FAB2CA0E55-seeklogo.com.png" alt="Imagem do título <?php echo $titulo->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $titulo->displayName; ?> (<?php echo $titulo->titleText; ?>)</h5>
                        </div>
                    </div>
                </div>
                <?php
