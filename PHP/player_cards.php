<?php
    ...
    $url = 'https://valorant-api.com/v1/playercards?language=pt-BR';
    $ch = curl_init($url);
    ...
    $cartasPerPage = 12;
    $totalPages = ceil($totalCartas / $cartasPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $cartasPerPage;
    $currentCartas = array_slice($cartas, $start, $cartasPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
        ...
        <title>Valorant | Cartas de jogador</title>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-4">Cartas de jogador</h2>
            <div class="row">
                <?php
                    foreach($currentCartas as $carta){
                        $id = str_replace("https://valorant-api.com/v1/playercards/", "", $carta->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $carta->displayIcon; ?>" alt="Imagem da carta <?php echo $carta->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $carta->displayName; ?></h5>
                        </div>
                    </div>
                </div>
                <?php
