    ...
    <body>
        ...
        <div class="container">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="bundles.php">Bundles</a></li>
                ...
                <table class="table">
                    ...
                    <?php
                        foreach($resultado->data as $agente){
                            ...
                            echo "<td>".$agente->displayNameSubText."</td>";
                            echo "<td>".$agente->promoDescription."</td>";
                            echo "<td>"."<a href=$agente->displayIcon>Clique aqui</a>"."</td>";
                            echo "</tr>";
                        }
                    ?>
                </table>
