<?php
    ...
    $sprays = $resultado->data;
    $totalSprays = count($sprays);
    $spraysPerPage = 12;
    $totalPages = ceil($totalSprays / $spraysPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $spraysPerPage;
    $currentSprays = array_slice($sprays, $start, $spraysPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-4">Sprays</h2>
            <div class="row">
                <?php
                    foreach($currentSprays as $spray){
                        $id = str_replace("https://valorant-api.com/v1/sprays/", "", $spray->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $spray->displayIcon; ?>" alt="Imagem do spray <?php echo $spray->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $spray->displayName; ?></h5>
                        </div>
                    </div>
                </div>
                <?php
