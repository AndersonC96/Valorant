<?php
    ...
    $url = 'https://valorant-api.com/v1/buddies?language=pt-BR';
    $ch = curl_init($url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
    $resultado = json_decode(curl_exec($ch));
    $companheiros = $resultado->data;
    $totalCompanheiros = count($companheiros);
    $companheirosPerPage = 12;
    $totalPages = ceil($totalCompanheiros / $companheirosPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $companheirosPerPage;
    $currentCompanheiros = array_slice($companheiros, $start, $companheirosPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
        ...
        <title>Valorant | Companheiros</title>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-4">Companheiros</h2>
            <div class="row">
                <?php
                    foreach($currentCompanheiros as $companheiro){
                        $id = str_replace("https://valorant-api.com/v1/buddies/", "", $companheiro->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $companheiro->displayIcon; ?>" alt="Imagem do companheiro <?php echo $companheiro->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $companheiro->displayName; ?></h5>
                            <p class="card-text">
                                <b style="color: #ff4655">Nível:</b> <?php echo $companheiro->levels[0]->displayName; ?><br>
                            </p>
                        </div>
                    </div>
                </div>
