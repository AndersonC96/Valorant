            ...
            <div class="row">
                <?php
                    foreach($resultado->data as $agente){
                        $id = str_replace("https://valorant-api.com/v1/weapons/", "", $agente->uuid);
                ?>
                <div class="col-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <b style="color: #ff4655">Categoria: </b><?php echo $agente->shopData->category; ?> (<?php echo $agente->shopData->categoryText; ?>)<br>
                            </p>
                        </div>
                    </div>
                </div>
