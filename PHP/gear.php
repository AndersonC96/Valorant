            ...
            <div class="row">
                <?php
                    foreach($resultado->data as $agente){
                        $id = str_replace("https://valorant-api.com/v1/gear/", "", $agente->uuid);
                ?>
                <div class="col-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <b style="color: #ff4655">Preço: </b><?php echo $agente->shopData->cost; ?><br>
                                <b style="color: #ff4655">Categorias: </b><?php echo $agente->shopData->category; ?> (<?php echo $agente->shopData->categoryText; ?>)<br>
                            </p>
                        </div>
                    </div>
                </div>
