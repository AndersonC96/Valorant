    ...
    <body>
        ...
        <div class="container">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="gear.php">Equipamento</a></li>
                ...
                <table class="table">
                    ...
                    <?php
                        foreach($resultado->data as $agente){
                            ...
                            echo "<td>".$agente->shopData->cost."</td>";
                            echo "<td>".$agente->shopData->category."</td>";
                            echo "<td>".$agente->shopData->categoryText."</td>";
                            echo "</tr>";
                        }
                    ?>
                </table>
