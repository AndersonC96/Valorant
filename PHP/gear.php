<?php
    ...
    $url = 'https://valorant-api.com/v1/gear?language=pt-BR';
    $ch = curl_init($url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
    $resultado = json_decode(curl_exec($ch));
    $equipamentos = $resultado->data;
    $totalEquipamentos = count($equipamentos);
    $equipamentosPerPage = 12;
    $totalPages = ceil($totalEquipamentos / $equipamentosPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $equipamentosPerPage;
    $currentEquipamentos = array_slice($equipamentos, $start, $equipamentosPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
        ...
        <title>Valorant | Equipamento</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <?php
                    foreach($currentEquipamentos as $equipamento){
                        $id = str_replace("https://valorant-api.com/v1/gear/", "", $equipamento->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $equipamento->displayIcon; ?>" alt="Imagem do equipamento <?php echo $equipamento->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $equipamento->displayName; ?></h5>
                            <p class="card-text">
                                <b style="color: #ff4655">Descrição: </b><?php echo $equipamento->description; ?><br>
                                <b style="color: #ff4655">Preço: </b><?php echo $equipamento->shopData->cost; ?><br>
                                <b style="color: #ff4655">Categorias: </b><?php echo $equipamento->shopData->category; ?> (<?php echo $equipamento->shopData->categoryText; ?>)<br>
                            </p>
                        </div>
                    </div>
                </div>
