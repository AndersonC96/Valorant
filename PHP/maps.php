            ...
            <div class="row">
                <?php
                    foreach($resultado->data as $agente){
                        $id = str_replace("https://valorant-api.com/v1/maps/", "", $agente->uuid);
                ?>
                <div class="col-3">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $agente->splash; ?>" alt="Imagem do agente <?php echo $agente->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $agente->displayName; ?></h5>
                            <p class="card-text">
                                <b style="color: #ff4655">Coordenadas: </b><?php echo $agente->coordinates; ?><br>
                                <b style="color: #ff4655">Nome da região:</b>
                                <ul>
                                    <?php
                                        foreach($agente->callouts as $habilidade){
                                            echo "<li>".$habilidade->regionName."</li>";
                                        }
                                    ?>
                                </ul>
                                <br>
