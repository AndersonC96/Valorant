            ...
            <div class="row">
                <?php
                    foreach($resultado->data as $agente){
                        $id = str_replace("https://valorant-api.com/v1/events/", "", $agente->uuid);
                ?>
                <div class="col-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $agente->displayName; ?> (<?php echo $agente->shortDisplayName; ?>)</h5>
                            <p class="card-text">
                                <b style="color: #ff4655">Início:</b> <?php echo date("d/m/Y",strtotime($agente->startTime)) ?><br>
                                <b style="color: #ff4655">Fim</b> <?php echo date("d/m/Y",strtotime($agente->endTime)) ?> <br>
                            </p>
                        </div>
                    </div>
                </div>
