<?php
    ...
    $url = 'https://valorant-api.com/v1/events?language=pt-BR';
    $ch = curl_init($url);
    ...
    $eventosPerPage = 12;
    $totalPages = ceil($totalEventos / $eventosPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $eventosPerPage;
    $currentEventos = array_slice($eventos, $start, $eventosPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
            ...
            <div class="row">
                <?php
                    foreach($currentEventos as $evento){
                        $id = str_replace("https://valorant-api.com/v1/events/", "", $evento->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="https://seeklogo.com/images/V/valorant-logo-FAB2CA0E55-seeklogo.com.png" alt="Imagem do evento <?php echo $evento->displayName; ?>">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ff4655"><?php echo $evento->displayName; ?> (<?php echo $evento->shortDisplayName; ?>)</h5>
                            <p class="card-text">
                                <b style="color: #ff4655">Início:</b> <?php echo date("d/m/Y", strtotime($evento->startTime)); ?><br>
                                <b style="color: #ff4655">Fim:</b> <?php echo date("d/m/Y", strtotime($evento->endTime)); ?><br>
                            </p>
                        </div>
                    </div>
                </div>
