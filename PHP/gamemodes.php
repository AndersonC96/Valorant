<?php
    ...
    $modos = $resultado->data;
    $totalModos = count($modos);
    $modosPerPage = 12;
    $totalPages = ceil($totalModos / $modosPerPage);
    $currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
    $start = ($currentPage - 1) * $modosPerPage;
    $currentModos = array_slice($modos, $start, $modosPerPage);
?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
        ...
        <title>Valorant | Modos de jogo</title>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-4">Modos de jogo</h2>
            <div class="row">
                <?php
                    foreach($currentModos as $modo){
                        $id = str_replace("https://valorant-api.com/v1/gamemodes/", "", $modo->uuid);
                ?>
                <div class="col-md-3 mb-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo $modo->displayIcon; ?>" alt="Imagem do modo <?php echo $modo->displayName; ?>">
                        <div class="card-body">
